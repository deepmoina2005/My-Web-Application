...
import { FaCalendarDays, FaFacebook } from "react-icons/fa6";
        ...
        <div className="container">
          <div className="flex w-100">
            <div className="heroinfoleft">
              ...
              <a href="/img/Resume.pdf" download="Resume.pdf" className="download_cv">Download CV<BiDownload/></a>
                <ul className="hero_social">
                  ...
                  <li>
                    <a href="https://fastidious-frangollo-1e6409.netlify.app/">
                      <LiaBasketballBallSolid />
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/in/deepmoina-boruah/">
                      <GrLinkedin />
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/deepmoina2005">
                      <FaGithub />
                    </a>
                  </li>
                </ul>
